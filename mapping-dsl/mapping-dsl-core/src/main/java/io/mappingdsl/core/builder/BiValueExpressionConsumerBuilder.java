...
public class BiValueExpressionConsumerBuilder<SRC_ROOT, SRC_TYPE, TRG_ROOT, TRG_TYPE> {
    ...
    public BiExpressionsChainBuilder<SRC_ROOT, SRC_TYPE, TRG_ROOT, TRG_TYPE> to(
