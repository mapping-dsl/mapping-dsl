...
class BiConverterMappingTest {
    ...
    void shouldMapConvertedCollectionElements(String testName, MappingDsl mappingDsl, BiMappingTestFlow testFlow) {
    ...
    void shouldMapCollectionOfComplexConvertedValues(String testName, MappingDsl mappingDsl, BiMappingTestFlow testFlow) {
